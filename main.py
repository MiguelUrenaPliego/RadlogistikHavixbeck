...
bike_score_config = {
    "access_restrictions": {
        ...
        "ignore": {
            "pedestrian+bikes": ["bike_separation", "highway", "lanes", "car_maxspeed", "highway"],
            "private":          ["bike_separation", "highway", "lanes", "car_maxspeed", "highway"],
            "pedestrian":       ["bike_separation", "highway", "lanes", "car_maxspeed", "highway"],
        },
    },
    "bike_separation": {
